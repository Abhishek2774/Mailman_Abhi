...
if (isset($_POST['reset_link'])){
    $email_add=$_POST['email'];
        ...
        if ($result->num_rows) {
            ...
            <a href='http://hestalabs.com/tse/Mailman_Abhi/reset_password_bakend.php?reset=" . $reset_link . "&unique_id=" . $unique_id . "' style='    color: #fff;background-color: #B8FF33;border-color: #198754;padding: 0.5rem 1rem;font-size: 1.25rem;border-radius: 0.3rem;'>Reset Password</a>";
